...
INSERT INTO `sys_operate_log` VALUES (2326, 'admin', '/sys/menu', 'POST', '添加菜单', '127.0.0.1', '内网IP|内网IP', 87, '2026-07-17 11:03:54', '{\"menu\":{\"createTime\":\"2026-07-17 11:03:53\",\"updateTime\":\"2026-07-17 11:03:53\",\"params\":null,\"id\":114,\"parentId\":112,\"path\":\"\",\"component\":\"\",\"title\":\"上传文件\",\"sort\":1,\"icon\":\"\",\"type\":\"BUTTON\",\"redirect\":\"\",\"name\":\"\",\"hidden\":1,\"isExternal\":0,\"perm\":\"sys:file:upload\",\"children\":null}}', 'com.nexora.controller.system.SysMenuController', 'addMenu', '2026-07-17 11:03:54');
INSERT INTO `sys_operate_log` VALUES (2327, 'admin', '/sys/menu', 'POST', '添加菜单', '127.0.0.1', '内网IP|内网IP', 9, '2026-07-17 11:04:36', '{\"menu\":{\"createTime\":\"2026-07-17 11:04:35\",\"updateTime\":\"2026-07-17 11:04:35\",\"params\":null,\"id\":115,\"parentId\":112,\"path\":\"\",\"component\":\"\",\"title\":\"删除文件\",\"sort\":1,\"icon\":\"\",\"type\":\"BUTTON\",\"redirect\":\"\",\"name\":\"\",\"hidden\":1,\"isExternal\":0,\"perm\":\"sys:file:delete\",\"children\":null}}', 'com.nexora.controller.system.SysMenuController', 'addMenu', '2026-07-17 11:04:36');
INSERT INTO `sys_operate_log` VALUES (2328, 'admin', '/sys/user/updProfile', 'PUT', '修改个人信息', '127.0.0.1', '内网IP|内网IP', 29, '2026-07-17 11:04:50', '{\"user\":{\"createTime\":null,\"updateTime\":\"2026-07-17 11:04:50\",\"params\":null,\"id\":1,\"username\":null,\"password\":null,\"status\":null,\"ip\":null,\"ipLocation\":null,\"os\":null,\"browser\":null,\"nickname\":null,\"avatar\":\"https://oss.wuhobin.top/base/20260717/6a599bd05554dc0c71e4db80.jpg\",\"mobile\":null,\"email\":null,\"sex\":null,\"loginType\":null,\"lastLoginTime\":null}}', 'com.nexora.controller.system.SysUserController', 'updateProfile', '2026-07-17 11:04:50');
INSERT INTO `sys_operate_log` VALUES (2329, 'admin', '/sys/user/updProfile', 'PUT', '修改个人信息', '127.0.0.1', '内网IP|内网IP', 90, '2026-07-17 11:29:07', '{\"user\":{\"createTime\":null,\"updateTime\":\"2026-07-17 11:29:07\",\"params\":null,\"id\":1,\"username\":null,\"password\":null,\"status\":null,\"ip\":null,\"ipLocation\":null,\"os\":null,\"browser\":null,\"nickname\":null,\"avatar\":\"https://oss.wuhobin.top/base/20260717/6a59a182555419c251de00f2.jpg\",\"mobile\":null,\"email\":null,\"sex\":null,\"loginType\":null,\"lastLoginTime\":null}}', 'com.nexora.controller.system.SysUserController', 'updateProfile', '2026-07-17 11:29:07');
INSERT INTO `sys_operate_log` VALUES (2330, 'admin', '/sys/dict/add', 'POST', '添加字典', '127.0.0.1', '内网IP|内网IP', 12, '2026-07-17 11:47:22', '{\"dict\":{\"createTime\":\"2026-07-17 11:47:22\",\"updateTime\":\"2026-07-17 11:47:22\",\"params\":null,\"id\":31,\"name\":\"file_type\",\"type\":\"1\",\"status\":1,\"remark\":\"\",\"sort\":null}}', 'com.nexora.controller.system.SysDictController', 'addDict', '2026-07-17 11:47:22');
INSERT INTO `sys_operate_log` VALUES (2331, 'admin', '/sys/dict/add', 'POST', '添加字典', '127.0.0.1', '内网IP|内网IP', 14, '2026-07-17 11:47:42', '{\"dict\":{\"createTime\":\"2026-07-17 11:47:42\",\"updateTime\":\"2026-07-17 11:47:42\",\"params\":null,\"id\":32,\"name\":\"11\",\"type\":\"11\",\"status\":1,\"remark\":\"\",\"sort\":null}}', 'com.nexora.controller.system.SysDictController', 'addDict', '2026-07-17 11:47:42');
INSERT INTO `sys_operate_log` VALUES (2332, 'admin', '/sys/dict/add', 'POST', '添加字典', '127.0.0.1', '内网IP|内网IP', 63, '2026-07-17 11:47:49', '{\"dict\":{\"createTime\":\"2026-07-17 11:47:48\",\"updateTime\":\"2026-07-17 11:47:48\",\"params\":null,\"id\":33,\"name\":\"11\",\"type\":\"打\",\"status\":1,\"remark\":\"\",\"sort\":null}}', 'com.nexora.controller.system.SysDictController', 'addDict', '2026-07-17 11:47:49');
INSERT INTO `sys_operate_log` VALUES (2333, 'admin', '/sys/dict/delete/31', 'DELETE', '删除字典', '127.0.0.1', '内网IP|内网IP', 61, '2026-07-17 11:47:55', '{\"ids\":[31]}', 'com.nexora.controller.system.SysDictController', 'delete', '2026-07-17 11:47:55');
INSERT INTO `sys_operate_log` VALUES (2334, 'admin', '/sys/dict/delete/32', 'DELETE', '删除字典', '127.0.0.1', '内网IP|内网IP', 10, '2026-07-17 11:47:59', '{\"ids\":[32]}', 'com.nexora.controller.system.SysDictController', 'delete', '2026-07-17 11:47:59');
INSERT INTO `sys_operate_log` VALUES (2335, 'admin', '/sys/dictData/update', 'PUT', '修改字典数据', '127.0.0.1', '内网IP|内网IP', 15, '2026-07-17 11:57:52', '{\"dictData\":{\"id\":38,\"dictId\":1,\"label\":\"图片\",\"value\":\"image/jpeg\",\"style\":\"success\",\"isDefault\":null,\"sort\":1,\"remark\":\"image/jpeg\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'updateDictData', '2026-07-17 11:57:52');
INSERT INTO `sys_operate_log` VALUES (2336, 'admin', '/sys/dictData/add', 'POST', '新增字典数据', '127.0.0.1', '内网IP|内网IP', 7, '2026-07-17 11:58:17', '{\"dictData\":{\"id\":44,\"dictId\":1,\"label\":\"image/png\",\"value\":\"image/png\",\"style\":\"success\",\"isDefault\":null,\"sort\":0,\"remark\":\"image/png\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'addDictData', '2026-07-17 11:58:17');
INSERT INTO `sys_operate_log` VALUES (2337, 'admin', '/sys/dictData/update', 'PUT', '修改字典数据', '127.0.0.1', '内网IP|内网IP', 10, '2026-07-17 11:58:36', '{\"dictData\":{\"id\":38,\"dictId\":1,\"label\":\"image/jpeg\",\"value\":\"image/jpeg\",\"style\":\"success\",\"isDefault\":null,\"sort\":1,\"remark\":\"image/jpeg\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'updateDictData', '2026-07-17 11:58:36');
INSERT INTO `sys_operate_log` VALUES (2338, 'admin', '/sys/dictData/update', 'PUT', '修改字典数据', '127.0.0.1', '内网IP|内网IP', 43, '2026-07-17 11:58:52', '{\"dictData\":{\"id\":39,\"dictId\":1,\"label\":\"image/gif\",\"value\":\"image/gif\",\"style\":\"danger\",\"isDefault\":null,\"sort\":2,\"remark\":\"image/gif\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'updateDictData', '2026-07-17 11:58:52');
INSERT INTO `sys_operate_log` VALUES (2339, 'admin', '/sys/dictData/update', 'PUT', '修改字典数据', '127.0.0.1', '内网IP|内网IP', 23, '2026-07-17 11:59:13', '{\"dictData\":{\"id\":40,\"dictId\":1,\"label\":\"image/webp\",\"value\":\"image/webp\",\"style\":\"warning\",\"isDefault\":null,\"sort\":3,\"remark\":\"image/webp\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'updateDictData', '2026-07-17 11:59:13');
INSERT INTO `sys_operate_log` VALUES (2340, 'admin', '/sys/dictData/update', 'PUT', '修改字典数据', '127.0.0.1', '内网IP|内网IP', 8, '2026-07-17 11:59:37', '{\"dictData\":{\"id\":41,\"dictId\":1,\"label\":\"video/mp4\",\"value\":\"video/mp4\",\"style\":\"primary\",\"isDefault\":null,\"sort\":4,\"remark\":\"video/mp4\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'updateDictData', '2026-07-17 11:59:37');
INSERT INTO `sys_operate_log` VALUES (2341, 'admin', '/sys/dictData/update', 'PUT', '修改字典数据', '127.0.0.1', '内网IP|内网IP', 48, '2026-07-17 11:59:57', '{\"dictData\":{\"id\":42,\"dictId\":1,\"label\":\"application/pdf\",\"value\":\"application/pdf\",\"style\":\"info\",\"isDefault\":null,\"sort\":5,\"remark\":\"application/pdf\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'updateDictData', '2026-07-17 11:59:57');
INSERT INTO `sys_operate_log` VALUES (2342, 'admin', '/sys/dictData/update', 'PUT', '修改字典数据', '127.0.0.1', '内网IP|内网IP', 9, '2026-07-17 12:00:23', '{\"dictData\":{\"id\":43,\"dictId\":1,\"label\":\"application/zip\",\"value\":\"application/zip\",\"style\":\"info\",\"isDefault\":null,\"sort\":6,\"remark\":\"application/zip\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'updateDictData', '2026-07-17 12:00:23');
INSERT INTO `sys_operate_log` VALUES (2343, 'admin', '/sys/dictData/add', 'POST', '新增字典数据', '127.0.0.1', '内网IP|内网IP', 48, '2026-07-17 12:00:48', '{\"dictData\":{\"id\":45,\"dictId\":1,\"label\":\"text/plain\",\"value\":\"text/plain\",\"style\":\"info\",\"isDefault\":null,\"sort\":8,\"remark\":\"text/plain\",\"status\":1}}', 'com.nexora.controller.system.SysDictDataController', 'addDictData', '2026-07-17 12:00:48');
INSERT INTO `sys_operate_log` VALUES (2344, 'admin', '/sys/menu', 'POST', '添加菜单', '127.0.0.1', '内网IP|内网IP', 129, '2026-07-17 12:31:48', '{\"menu\":{\"createTime\":\"2026-07-17 12:31:48\",\"updateTime\":\"2026-07-17 12:31:48\",\"params\":null,\"id\":116,\"parentId\":112,\"path\":\"\",\"component\":\"\",\"title\":\"下载文件\",\"sort\":1,\"icon\":\"\",\"type\":\"BUTTON\",\"redirect\":\"\",\"name\":\"\",\"hidden\":1,\"isExternal\":0,\"perm\":\"sys:file:download\",\"children\":null}}', 'com.nexora.controller.system.SysMenuController', 'addMenu', '2026-07-17 12:31:48');
INSERT INTO `sys_operate_log` VALUES (2345, 'admin', '/sys/role/menus/1', 'PUT', '修改角色权限', '127.0.0.1', '内网IP|内网IP', 86, '2026-07-17 21:09:51', '{\"id\":1,\"menuIds\":[4,18,58,59,60,61,62,19,63,66,64,111,112,116,113,114,115]}', 'com.nexora.controller.system.SysRoleController', 'updateRoleMenus', '2026-07-17 21:09:51');
INSERT INTO `sys_operate_log` VALUES (2346, 'admin', '/sys/role/menus/1', 'PUT', '修改角色权限', '127.0.0.1', '内网IP|内网IP', 30, '2026-07-17 21:26:27', '{\"id\":1,\"menuIds\":[1,14,39,27,28,29,52,2,8,3,40,41,43,9,53,10,11,12,13,48,51,49,50,32,33,55,56,54,4,18,58,59,60,61,62,19,63,66,64,30,111,112,116,113,114,115]}', 'com.nexora.controller.system.SysRoleController', 'updateRoleMenus', '2026-07-17 21:26:27');
INSERT INTO `sys_operate_log` VALUES (2347, 'admin', '/sys/role/menus/2', 'PUT', '修改角色权限', '127.0.0.1', '内网IP|内网IP', 19, '2026-07-17 21:27:42', '{\"id\":2,\"menuIds\":[111,112,116,113,114,115]}', 'com.nexora.controller.system.SysRoleController', 'updateRoleMenus', '2026-07-17 21:27:42');
INSERT INTO `sys_operate_log` VALUES (2348, 'user', '/sys/user/updProfile', 'PUT', '修改个人信息', '127.0.0.1', '内网IP|内网IP', 151, '2026-07-19 17:08:08', '{\"form\":{\"nickname\":\"普通用户1\",\"avatar\":null,\"mobile\":\"18772916901\",\"email\":\"1289066006@qq.com\",\"sex\":1}}', 'com.nexora.controller.system.SysUserController', 'updateProfile', '2026-07-19 17:08:08');
INSERT INTO `sys_operate_log` VALUES (2349, 'user', '/sys/user/updProfile', 'PUT', '修改个人信息', '127.0.0.1', '内网IP|内网IP', 13, '2026-07-19 17:08:15', '{\"form\":{\"nickname\":null,\"avatar\":\"https://oss.wuhobin.top/base/20260719/6a5c93fd80e6bd74478afdc1.jpg\",\"mobile\":null,\"email\":null,\"sex\":null}}', 'com.nexora.controller.system.SysUserController', 'updateProfile', '2026-07-19 17:08:15');
INSERT INTO `sys_operate_log` VALUES (2350, 'admin', '/sys/menu/52', 'DELETE', '删除菜单', '127.0.0.1', '内网IP|内网IP', 21, '2026-07-19 17:09:05', '{\"id\":52}', 'com.nexora.controller.system.SysMenuController', 'deleteMenu', '2026-07-19 17:09:05');
