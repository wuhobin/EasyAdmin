...
class VerificationMailRequestFactoryTest {
    ...
    void rendersGenericCopyForCustomScene() {
        ...
        MailVerificationSendRequest request =
                VerificationMailRequestFactory.createRequest("user@example.com", customScene);
    ...
    private static void assertScene(CommonVerificationScene scene, String title, String sceneName) {
        MailVerificationSendRequest request =
                VerificationMailRequestFactory.createRequest("user@example.com", scene);
